...
import type { WebSocketEvent, SubscriptionChannel, ServerMessage } from '@stoneforge/shared-routes';
...
/**
 * Runtime-agnostic ServerWebSocket type (replaces bun's ServerWebSocket)
 */
