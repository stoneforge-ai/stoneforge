...
- **`BlockedCacheService` not exported from `packages/quarry/src/services/index.ts`** - use the main package entry instead: `import { createBlockedCacheService } from '@stoneforge/quarry'`
