...
var Removable = (_d = class {
  ...
  updateGcTime(newGcTime) {
    this.gcTime = Math.max(
      this.gcTime || 0,
      newGcTime ?? (isServer$1 ? Infinity : 5 * 60 * 1e3)
    );
  }
  clearGcTimeout() {
...
var QueriesObserver = (_j = class extends Subscribable {
  ...
  if (combine) {
    ...
    if (!__privateGet(this, _combinedResult) || __privateGet(this, _result) !== __privateGet(this, _lastResult) || queryHashesChanged || combine !== __privateGet(this, _lastCombine)) {
      ...
      __privateSet(this, _combinedResult, replaceEqualDeep$1(
...
function useBaseQuery(options, Observer, queryClient) {
  ...
  if (defaultedOptions.experimental_prefetchInRender && !isServer$1 && willFetch(result, isRestoring)) {
...
function useLinkProps(options, forwardedRef) {
  ...
  const next = reactExports.useMemo(
    () => router.buildLocation({ ..._options2 }),
    [router, _options2]
  );
  ...
  const doPreload = reactExports.useCallback(() => {
    router.preloadRoute({ ..._options2 }).catch((err) => {
      console.warn(err);
...
function Matches() {
  ...
  const pendingElement = PendingComponent ? /* @__PURE__ */ jsxRuntimeExports.jsx(PendingComponent, {}) : null;
  const ResolvedSuspense = typeof document !== "undefined" && router.ssr ? SafeFragment : reactExports.Suspense;
...
export {
  ...
  reactExports as r,
  useSearch as s,
  useSyncExternalStoreExports as t,
  useQuery as u,
  getAugmentedNamespace as v,
  withSelectorExports as w,
  createRootRoute as x,
  createRoute as y,
  createRouter as z
};
//# sourceMappingURL=router-vendor-DCoXf9-V.js.map
