...
> Archived reference workspace. Active Stoneforge V2 work lives at the repository root, and the canonical V2 charter lives in `docs/v2/README.md`. Treat `reference/v1/` as V1 reference unless a task explicitly targets it.
