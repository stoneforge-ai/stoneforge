---
title: Task Planning
description: How to create effective plans that decompose work into parallelizable tasks for AI agents — with priorities, dependencies, and optimal batch sizes.
---
