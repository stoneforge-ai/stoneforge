---
title: Agent Roles
description: Understand the different AI agent roles in Stoneforge — Director for planning, Worker for coding, and Steward for merge review — and how they collaborate in parallel.
---
