...
description: A complete walkthrough building a real feature with multiple AI coding agents working in parallel — from planning to merge, with Stoneforge orchestration.
---
...
<LinkCard title="Use Cases" description="See how teams use multi-agent orchestration in practice" href="https://stoneforge.ai/use-cases" />
