...
description: The core engine that drives multi-agent AI coordination — dispatch daemon, priority-based task assignment, message routing, and automatic recovery from failures.
---
...
<LinkCard
  ...
  href="/core-concepts/dependency-system/"
/>
<LinkCard
  title="Auto-Dispatch"
