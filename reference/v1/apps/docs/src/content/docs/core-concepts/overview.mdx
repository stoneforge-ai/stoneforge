---
title: Overview
description: Understand the fundamental building blocks of Stoneforge — elements, tasks, AI agents, git worktrees, and the orchestration loop that coordinates parallel development.
---
