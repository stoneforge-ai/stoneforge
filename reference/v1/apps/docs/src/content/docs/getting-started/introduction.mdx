...
<Aside type="note">
  Looking for a high-level overview before diving into the docs? Check out the [Stoneforge product page](https://stoneforge.ai) for an introduction to what Stoneforge does and how it fits into your workflow.
</Aside>
