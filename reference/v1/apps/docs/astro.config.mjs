          ...
          items: [
            ...
            },
            {
              ...
              items: [
                ...
                { label: 'Event Sourcing', slug: 'core-concepts/event-sourcing' },
                { label: 'Orchestration Loop', slug: 'core-concepts/orchestration-loop' },
                { label: 'Worktree Isolation', slug: 'core-concepts/worktree-isolation' },
                { label: 'Dependency System', slug: 'core-concepts/dependency-system' },
                { label: 'Storage', slug: 'core-concepts/storage' },
                { label: 'Sync & Merge', slug: 'core-concepts/sync-and-merge' },
              ],
            },
            {
              label: 'Guides',
