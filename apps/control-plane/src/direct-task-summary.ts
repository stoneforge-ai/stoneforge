import type { Assignment, Session, Task } from "@stoneforge/execution"
...
export function buildSummary(
  ...
  return {
    ...
    approvalGateSatisfied: input.mergeRequest.reviewOutcomes.some(
      (reviewOutcome) => {
        return (
          reviewOutcome.outcome === "approved" &&
          reviewOutcome.reviewerKind === "human"
        )
      }
    ),
...
export function expectDirectTaskRunComplete(
  summary: DirectTaskRunSummary
): void {
